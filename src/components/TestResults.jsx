...
const DEFAULT_DATA = {
  ...
  failed: 0,
  tests: [
    { name: 'test_page_loads_and_title_correct', status: 'passed', duration: '0.150s' },
    { name: 'test_hero_section_visible', status: 'passed', duration: '0.120s' },
    { name: 'test_hero_title_contains_qa', status: 'passed', duration: '0.110s' },
    { name: 'test_nav_link_about_exists', status: 'passed', duration: '0.095s' },
    { name: 'test_nav_link_skills_exists', status: 'passed', duration: '0.090s' },
    { name: 'test_nav_link_projects_exists', status: 'passed', duration: '0.088s' },
    { name: 'test_nav_link_contact_exists', status: 'passed', duration: '0.092s' },
    { name: 'test_skills_section_has_python_tag', status: 'passed', duration: '0.105s' },
    { name: 'test_skills_section_has_playwright_tag', status: 'passed', duration: '0.098s' },
    { name: 'test_skills_section_has_pytest_tag', status: 'passed', duration: '0.101s' },
    { name: 'test_projects_section_has_three_cards', status: 'passed', duration: '0.115s' },
    { name: 'test_contact_section_has_four_items', status: 'passed', duration: '0.089s' },
    { name: 'test_mobile_no_horizontal_overflow', status: 'passed', duration: '0.200s' },
    { name: 'test_page_loads_under_3_seconds', status: 'passed', duration: '0.180s' },
    { name: 'test_no_broken_images', status: 'passed', duration: '0.350s' },
  ],
}
